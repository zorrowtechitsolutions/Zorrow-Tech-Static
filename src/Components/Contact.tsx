      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row gap-6 items-stretch">
            {/* Contact Information */}
            <div className="flex-1 bg-white rounded-lg shadow space-y-8">
              <div className="border border-primary overflow-hidden relative rounded-lg h-full w-full p-6">
              {/* ----- */}
            ...
            <div className="flex-1 h-[300px] md:h-auto">
              <div className="border border-primary overflow-hidden relative rounded-lg h-full w-full">
                <iframe
